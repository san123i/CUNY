...
path<-"C://CUNY/GIT/CUNY_NEW/CUNY/Semester4/622-MachineLearning/datasets/heart.csv"
ecolipath<-"C://CUNY/GIT/CUNY_NEW/CUNY/Semester4/622-MachineLearning/datasets/ecoli.csv"
