...
1.  What does a streak length of 1 mean, i.e. how many hits and misses are in a 
    ...
    A streak length of 1 says it was single hit event followed by a miss. 
...
2.  Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. 
    ...
    The distribution of Kobe's streak length is unimodal and right skewed.
...
```
   ...
   How does Kobe Bryant's distribution of streak lengths compare to the 
    ...
    Comparing the Kobe Bryant's and Simulated shooter's distribution of streak length, it is visible that  there is not evidence of hot hand, since the number of success streaks is max at 1 and 2 is no where closer to it. Which means the probability of consecutive hits is independent.
